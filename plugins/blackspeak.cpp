...
static void GeneratePlayerOnSvg(const AccentPalette& pal, char* outBuf, size_t maxLen) {
    snprintf(outBuf, maxLen,
        ...
        "  <defs>\n"
        "    <radialGradient id=\"bloom_grad\" cx=\"50%%\" cy=\"50%%\" r=\"50%%\">\n"
        "      <stop offset=\"0%%\" stop-color=\"%s\" stop-opacity=\"0.95\"/>\n"
        "      <stop offset=\"50%%\" stop-color=\"%s\" stop-opacity=\"0.55\"/>\n"
        "      <stop offset=\"75%%\" stop-color=\"%s\" stop-opacity=\"0.20\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"%s\" stop-opacity=\"0.0\"/>\n"
        "    </radialGradient>\n"
        "    <linearGradient id=\"bezel_grad\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        "      <stop offset=\"0%%\" stop-color=\"#2A303F\"/>\n"
        "      <stop offset=\"50%%\" stop-color=\"#12151C\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"#08090C\"/>\n"
        "    </linearGradient>\n"
        "    <radialGradient id=\"core_energy\" cx=\"45%%\" cy=\"38%%\" r=\"62%%\">\n"
        "      <stop offset=\"0%%\" stop-color=\"#FFFFFF\"/>\n"
        "      <stop offset=\"18%%\" stop-color=\"%s\"/>\n"
        "      <stop offset=\"55%%\" stop-color=\"%s\"/>\n"
        "      <stop offset=\"85%%\" stop-color=\"%s\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"#05070A\"/>\n"
        "    </radialGradient>\n"
        "    <linearGradient id=\"neon_ring\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        "      <stop offset=\"0%%\" stop-color=\"%s\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"%s\"/>\n"
        "    </linearGradient>\n"
        "    <linearGradient id=\"glass_specular\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        "      <stop offset=\"0%%\" stop-color=\"#FFFFFF\" stop-opacity=\"0.90\"/>\n"
        "      <stop offset=\"45%%\" stop-color=\"#FFFFFF\" stop-opacity=\"0.30\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"#FFFFFF\" stop-opacity=\"0.0\"/>\n"
        "    </linearGradient>\n"
        "    <radialGradient id=\"bottom_bounce\" cx=\"50%%\" cy=\"100%%\" r=\"50%%\">\n"
        "      <stop offset=\"0%%\" stop-color=\"%s\" stop-opacity=\"0.75\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"%s\" stop-opacity=\"0.0\"/>\n"
        "    </radialGradient>\n"
        "  </defs>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"63\" fill=\"url(#bloom_grad)\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"50\" fill=\"url(#bezel_grad)\" stroke=\"#060709\" stroke-width=\"2\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"46\" fill=\"#0A0C10\" stroke=\"url(#neon_ring)\" stroke-width=\"2.5\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"41\" fill=\"url(#core_energy)\"/>\n"
        "  <ellipse cx=\"64\" cy=\"94\" rx=\"26\" ry=\"9\" fill=\"url(#bottom_bounce)\"/>\n"
        "  <path d=\"M 38,50 C 38,36 48,28 64,28 C 80,28 90,36 90,50 C 78,56 50,56 38,50 Z\" fill=\"url(#glass_specular)\"/>\n"
        "  <circle cx=\"58\" cy=\"46\" r=\"6\" fill=\"#FFFFFF\" opacity=\"0.85\"/>\n"
        "</svg>\n",
        pal.glow, pal.accent, pal.primary, pal.primary,
        pal.glow, pal.accent, pal.primary,
        pal.glow, pal.primary,
...
static void GeneratePlayerCommanderOnSvg(const AccentPalette& pal, char* outBuf, size_t maxLen) {
    snprintf(outBuf, maxLen,
        ...
        "      <stop offset=\"100%%\" stop-color=\"%s\" stop-opacity=\"0.0\"/>\n"
        "    </radialGradient>\n"
        "    <linearGradient id=\"bezel_gold\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        ...
        "      <stop offset=\"100%%\" stop-color=\"#05070A\"/>\n"
        "    </radialGradient>\n"
        "    <linearGradient id=\"gold_ring\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        ...
        "  </defs>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"63\" fill=\"url(#bloom_grad)\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"51\" fill=\"url(#bezel_gold)\" stroke=\"#060709\" stroke-width=\"2\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"46\" fill=\"#0A0C10\" stroke=\"url(#gold_ring)\" stroke-width=\"2.5\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"41\" fill=\"url(#core_energy)\"/>\n"
        "  <ellipse cx=\"64\" cy=\"94\" rx=\"26\" ry=\"9\" fill=\"url(#bottom_bounce)\"/>\n"
        "  <path d=\"M 38,50 C 38,36 48,28 64,28 C 80,28 90,36 90,50 C 78,56 50,56 38,50 Z\" fill=\"url(#glass_specular)\"/>\n"
        "  <circle cx=\"58\" cy=\"46\" r=\"6\" fill=\"#FFFFFF\" opacity=\"0.85\"/>\n"
...
static void GeneratePlayerWhisperSvg(const AccentPalette& pal, char* outBuf, size_t maxLen) {
    snprintf(outBuf, maxLen,
        ...
        "      <stop offset=\"50%%\" stop-color=\"#EC4899\" stop-opacity=\"0.55\"/>\n"
        "      <stop offset=\"75%%\" stop-color=\"#DB2777\" stop-opacity=\"0.20\"/>\n"
        "      <stop offset=\"100%%\" stop-color=\"#831843\" stop-opacity=\"0.0\"/>\n"
        "    </radialGradient>\n"
        "    <linearGradient id=\"bezel_pink\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        ...
        "      <stop offset=\"100%%\" stop-color=\"#05070A\"/>\n"
        "    </radialGradient>\n"
        "    <linearGradient id=\"pink_ring\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\">\n"
        ...
        "  </defs>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"63\" fill=\"url(#bloom_grad)\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"51\" fill=\"url(#bezel_pink)\" stroke=\"#060709\" stroke-width=\"2\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"46\" fill=\"#0A0C10\" stroke=\"url(#pink_ring)\" stroke-width=\"2.5\"/>\n"
        "  <circle cx=\"64\" cy=\"64\" r=\"41\" fill=\"url(#core_energy)\"/>\n"
        "  <ellipse cx=\"64\" cy=\"94\" rx=\"26\" ry=\"9\" fill=\"url(#bottom_bounce)\"/>\n"
        "  <path d=\"M 38,50 C 38,36 48,28 64,28 C 80,28 90,36 90,50 C 78,56 50,56 38,50 Z\" fill=\"url(#glass_specular)\"/>\n"
        "  <circle cx=\"58\" cy=\"46\" r=\"6\" fill=\"#FFFFFF\" opacity=\"0.85\"/>\n"
